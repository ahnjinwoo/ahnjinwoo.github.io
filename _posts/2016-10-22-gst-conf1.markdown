...
* now maintained upstream with GStreamer

* released in lockstep with rest of GStreamer, tighter integration

* driver whitelist: only intel and mesa by default

* runtime feature checking

* perf and stability improvements

* vp9 encoding is ready for when the hardware for it comes out
